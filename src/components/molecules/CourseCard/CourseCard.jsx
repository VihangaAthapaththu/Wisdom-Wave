...
export function CourseCard({ course }) {
  ...
  return (
    <div className="block h-full">
      <Card className="group bg-white rounded-2xl p-6 border border-gray-100 shadow-sm hover:shadow-xl hover:shadow-[#FFA500]/5 transition-all duration-300 flex flex-col relative overflow-hidden h-full hover:-translate-y-1.5">
